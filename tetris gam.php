...
<head>
    ...
    z-index: -1000;
    max-width: 100%; /* Ensure video does not exceed viewport width */
    max-height: 100%; /* Ensure video does not exceed viewport height */
}

/* Additional CSS for the audio logo image */
#audioLogo {
    position: absolute;
    top: 10px;
    left: 10px;
...
<body>
<img id="audioLogo" src="mute.png" alt="Audio Logo" onclick="toggleAudio()" title="Click to toggle audio">
...
<video id="videoBG" autoplay muted loop>
    ...
    <script>
        ...
        function toggleAudio() {
            if (bgAudio.paused) {
                bgAudio.play();
                audioLogo.src = "high-volume.png"; // Unmuted audio logo
            } else {
                bgAudio.pause();
                audioLogo.src = "mute.png"; // Muted audio logo
            }
        }
      
 // Function to submit player name to the PHP script
 function submitPlayerName(name) {
        ...
        // Function to handle game over event and submit player name
        function gameOver() {
            var playerName = prompt("Game Over! Enter your name:");
            if (playerName !== null && playerName.trim() !== '') {
                submitPlayerName(playerName);
            } else {
                console.log('Player name not provided');
            }
        }
